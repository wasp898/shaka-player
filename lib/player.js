...
shaka.Player.prototype.load = function(manifestUri, opt_startTime,
  ...
  return loadChain.then(function() {
    ...
    if (this.abrManager_ && this.abrManager_.constructor == shaka.abr.CustomAbrManager) {
      var streamingEngine = this.streamingEngine_;
      this.abrManager_.supplyStreamingEngine(streamingEngine);
    }
...
shaka.Player.prototype.switchV21_ = function(streamsByType, opt_clearBuffer, 
  ...
  if (variant) {
    this.switch_(variant, opt_clearBuffer, opt_safeMargin);
  }
};
