...
goog.provide('shaka.dash.CustomDashParser');
 ...
 * @export
 */
shaka.dash.CustomDashParser = function() {
 ...
 * @const {number}
 */
shaka.dash.CustomDashParser.MIN_UPDATE_PERIOD_ = 3;
 ...
 * @const {number}
 */
shaka.dash.CustomDashParser.DEFAULT_SUGGESTED_PRESENTATION_DELAY_ = 10;
 ...
 * }
 */
shaka.dash.CustomDashParser.RequestInitSegmentCallback;
 ...
 */
shaka.dash.CustomDashParser.InheritanceFrame;
 ...
 *   period: ?shaka.dash.CustomDashParser.InheritanceFrame,
 *   periodInfo: ?shaka.dash.CustomDashParser.PeriodInfo,
 *   adaptationSet: ?shaka.dash.CustomDashParser.InheritanceFrame,
 *   representation: ?shaka.dash.CustomDashParser.InheritanceFrame,
 *   bandwidth: number,
 ...
 * @property {?shaka.dash.CustomDashParser.InheritanceFrame} period
 *   The inheritance from the Period element.
 * @property {?shaka.dash.CustomDashParser.PeriodInfo} periodInfo
 *   The Period info for the current Period.
 * @property {?shaka.dash.CustomDashParser.InheritanceFrame} adaptationSet
 *   The inheritance from the AdaptationSet element.
 * @property {?shaka.dash.CustomDashParser.InheritanceFrame} representation
 ...
 */
shaka.dash.CustomDashParser.Context;
 ...
 */
shaka.dash.CustomDashParser.PeriodInfo;
 ...
 */
shaka.dash.CustomDashParser.AdaptationInfo;
 ...
 */
shaka.dash.CustomDashParser.SegmentIndexFunctions;
 ...
 */
shaka.dash.CustomDashParser.StreamInfo;
 ...
 * @exportInterface
 */
shaka.dash.CustomDashParser.prototype.configure = function(config) {
 ...
 * @exportInterface
 */
shaka.dash.CustomDashParser.prototype.start = function(uri, playerInterface) {
 ...
 * @exportInterface
 */
shaka.dash.CustomDashParser.prototype.stop = function() {
  this.playerInterface_ = null;
  this.config_ = null;
  this.manifestUris_ = [];
  this.manifest_ = null;
 ...
 * @exportInterface
 */
shaka.dash.CustomDashParser.prototype.update = function() {
 ...
 * @exportInterface
 */
shaka.dash.CustomDashParser.prototype.onExpirationUpdated = function(
 ...
 * @private
 */
shaka.dash.CustomDashParser.prototype.requestManifest_ = function() {
 ...
 * @private
 */
shaka.dash.CustomDashParser.prototype.parseManifest_ =
 ...
 * @private
 */
shaka.dash.CustomDashParser.prototype.processManifest_ =
  ...
  if (this.manifest_) {
    ...
    var defaultPresentationDelay = Math.max(
        shaka.dash.CustomDashParser.DEFAULT_SUGGESTED_PRESENTATION_DELAY_,
        minBufferTime * 1.5);
  ...
  /** @type {shaka.dash.CustomDashParser.Context} */
  var context = {
 ...
 *
 * @param {shaka.dash.CustomDashParser.Context} context
 ...
 * @private
 */
shaka.dash.CustomDashParser.prototype.parsePeriods_ = function(
 ...
 * @param {shaka.dash.CustomDashParser.Context} context
 * @param {!Array.<string>} baseUris
 * @param {shaka.dash.CustomDashParser.PeriodInfo} periodInfo
 * @return {shakaExtern.Period}
 * @throws shaka.util.Error When there is a parsing error.
 * @private
 */
shaka.dash.CustomDashParser.prototype.parsePeriod_ = function(
...
/**
 * @param {!Array.<!shaka.dash.CustomDashParser.AdaptationInfo>} adaptationSets
 * @param {string} type
 * @return {!Array.<!shaka.dash.CustomDashParser.AdaptationInfo>}
 * @private
 */
shaka.dash.CustomDashParser.prototype.getSetsOfType_ = function(
    adaptationSets, type) {
 ...
 *
 * @param {?shaka.dash.CustomDashParser.AdaptationInfo} audio
 * @param {?shaka.dash.CustomDashParser.AdaptationInfo} video
 * @param {!Array.<shakaExtern.Variant>} variants New variants are pushed onto
 *   this array.
 * @private
 */
shaka.dash.CustomDashParser.prototype.createVariants_ =
 ...
 * @return {?shaka.dash.CustomDashParser.AdaptationInfo}
 * @throws shaka.util.Error When there is a parsing error.
 * @private
 */
shaka.dash.CustomDashParser.prototype.parseAdaptationSet_ = function(context, elem) {
  var XmlUtils = shaka.util.XmlUtils;
  var Functional = shaka.util.Functional;
  var ManifestParserUtils = shaka.util.ManifestParserUtils;
  ...
  var viewpointConfigs = XmlUtils.findChildren(elem, 'Viewpoint');
  var viewpointValue = this.parseViewpoint_(viewpointConfigs);
  console.log('viewpoint', viewpointValue);
  ...
  if (!context.adaptationSet.contentType ||
    ...
    context.adaptationSet.contentType =
        shaka.dash.CustomDashParser.guessContentType_(mimeType, codecs);
 ...
 * @private
 */
shaka.dash.CustomDashParser.prototype.parseRepresentation_ = function(
  ...
  /** @type {?shaka.dash.CustomDashParser.StreamInfo} */
  var streamInfo;
 ...
 * @private
 */
shaka.dash.CustomDashParser.prototype.onUpdate_ = function() {
 ...
 * @private
 */
shaka.dash.CustomDashParser.prototype.setUpdateTimer_ = function(offset) {
  ...
  var period =
      Math.max(shaka.dash.CustomDashParser.MIN_UPDATE_PERIOD_, this.updatePeriod_);
 ...
 *
 * @param {!Element} elem
 * @param {?shaka.dash.CustomDashParser.InheritanceFrame} parent
 * @param {Array.<string>} baseUris
 * @return {shaka.dash.CustomDashParser.InheritanceFrame}
 * @private
 */
shaka.dash.CustomDashParser.prototype.createFrame_ = function(
    elem, parent, baseUris) {
  goog.asserts.assert(parent || baseUris,
                      'Must provide either parent or baseUris');
  var ManifestParserUtils = shaka.util.ManifestParserUtils;
  var XmlUtils = shaka.util.XmlUtils;
  parent = parent || /** @type {shaka.dash.CustomDashParser.InheritanceFrame} */ ({
    contentType: '',
    mimeType: '',
    codecs: '',
  ...
  if (!contentType) {
    contentType = shaka.dash.CustomDashParser.guessContentType_(mimeType, codecs);
  }
...
/**
 * @param {!Array.<!Element>} viewpointConfigs the elements associated with the
 * Viewpoint keyword in the Adaptation Set
 * @return {?number} the value of the Viewpoint, or null if unknown
 * @private
 */
shaka.dash.CustomDashParser.prototype.parseViewpoint_ =
    function(viewpointConfigs) {
  for (var i = 0; i < viewpointConfigs.length; ++i) {
    var elem = viewpointConfigs[i];
    ...
    switch (scheme) {
      case 'urn:mpeg:dash:viewpoint:2011':
        var intValue = parseInt(value, 10);
        return intValue;
      default:
        shaka.log.warning('Unrecognized viewpoint scheme:', scheme, value);
        continue;
    }
  }
  return null;
 ...
 * @private
 */
shaka.dash.CustomDashParser.prototype.parseAudioChannels_ =
 ...
 *
 * @param {shaka.dash.CustomDashParser.InheritanceFrame} frame
 * @return {boolean} True if the Representation is usable; otherwise return
 *   false.
 * @private
 */
shaka.dash.CustomDashParser.prototype.verifyRepresentation_ = function(frame) {
  var ContentType = shaka.util.ManifestParserUtils.ContentType;
 ...
 * @private
 */
shaka.dash.CustomDashParser.prototype.requestForTiming_ =
 ...
 * @private
 */
shaka.dash.CustomDashParser.prototype.parseUtcTiming_ =
 ...
 * @private
 */
shaka.dash.CustomDashParser.prototype.parseEventStream_ = function(
 ...
 * @private
 */
shaka.dash.CustomDashParser.prototype.requestInitSegment_ = function(
 ...
 * @private
 */
shaka.dash.CustomDashParser.guessContentType_ = function(mimeType, codecs) {
...
shaka.media.ManifestParser.registerParserByExtension(
    'mpd', shaka.dash.CustomDashParser);
shaka.media.ManifestParser.registerParserByMime(
    'application/dash+xml', shaka.dash.CustomDashParser);
